...
CREATE TABLE `retur` (
  ...
  `book_name` varchar(5000) DEFAULT NULL,
  `book_no` varchar(5000) DEFAULT NULL,
  `user_no` varchar(45) DEFAULT NULL COMMENT '用户卡号',
  `user_name` varchar(45) DEFAULT NULL COMMENT '用户名称',
  `user_phone` varchar(45) DEFAULT NULL COMMENT '用户联系方式',
  `createtime` varchar(5000) DEFAULT NULL,
  `updatetime` datetime DEFAULT CURRENT_TIMESTAMP,
  `score` int DEFAULT NULL COMMENT '借书积分',
  `status` varchar(45) DEFAULT '已借出' COMMENT '借书状态',
  `days` int DEFAULT NULL COMMENT '借书天数',
  `return_date` datetime DEFAULT NULL COMMENT '归还日期',
  `real_date` datetime DEFAULT NULL COMMENT '真正的还书日期',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-11-29  9:25:58
